...
#define	_DBG_SECURITY(fmt, arg...)	DBG(DBG_SECURITY, fmt, ## arg)
...
{
	_DBG_SECURITY("security %p name %s", security, security->name);
				...
				enum connman_security_privilege privilege)
{
	...
	_DBG_SECURITY("message %p", message);
